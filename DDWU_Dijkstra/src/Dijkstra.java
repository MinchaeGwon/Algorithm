...
public class Dijkstra {
	...
	public static void print_distance(int v, int start) {
		for (int i = 1; i <= v; i++) {
			if (dist[i] == INF)
				System.out.println(start + "에서 " + i + "까지의 최단 경로: INF");
			else
				System.out.println(start + "에서 " + i + "까지의 최단 경로: " + dist[i]);
		}
	}
